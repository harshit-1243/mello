    ...
    <div className="flex flex-col" style={{ minHeight: "100vh" }}>
      ...
      <div className="flex items-end justify-between px-9 pt-9 pb-6 shrink-0" style={{ borderBottom: "1px solid #20183C" }}>
        <div>
          ...
          <h1 style={{ fontFamily: GS, fontSize: 56, fontWeight: 400, color: "#F3F1FB", lineHeight: 1.05, letterSpacing: "-0.025em", margin: 0 }}>Leads</h1>
          <p className="mt-2 text-sm" style={{ color: "#8C86A8" }}>Leads Mello recognises on calls · channel partners tracked</p>
        </div>
