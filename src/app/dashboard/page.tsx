    ...
    <div className="px-9 py-9 max-w-[1200px]">
      ...
      <div className="flex items-end justify-between mb-8">
        <div>
          ...
          <p className="mt-2 text-sm" style={{ color: "#8C86A8" }}>Your AI receptionist · answering calls and booking sessions</p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        ...
        <KpiCard label="Bookings"       value={String(stats.bookingsMade)} subtext={`${stats.bookingsMade - stats.bookingsMember} new · ${stats.bookingsMember} repeat`} />
        <KpiCard label="Revenue"        value={rupeesCompact(stats.revenueBookedInr)} subtext={`across ${stats.bookingsMade} booking${stats.bookingsMade === 1 ? "" : "s"}`} accent="#F5B544" />
      </div>
