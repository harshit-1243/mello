...
import { getBookings } from "@/lib/dashboard/data";
    ...
    <div className="flex flex-col" style={{ minHeight: "100vh" }}>
      ...
      <div className="flex items-end justify-between px-9 pt-9 pb-6 shrink-0" style={{ borderBottom: "1px solid #20183C" }}>
        <div>
          ...
          <h1 style={{ fontFamily: GS, fontSize: 56, fontWeight: 400, color: "#F3F1FB", lineHeight: 1.05, letterSpacing: "-0.025em", margin: 0 }}>Site Visits</h1>
          <p className="mt-2 text-sm" style={{ color: "#8C86A8" }}>All project site visits · booked by Mello</p>
        </div>
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 px-3 py-2 rounded-xl text-sm"
            style={{ background: "#181030", border: "1px solid #2A2348", color: "#8C86A8", width: 220 }}>
            <Search size={14} /><span className="flex-1 text-xs">Search leads, units…</span>
          </div>
      ...
      <BookingsView upcoming={upcoming} past={past} />
    </div>
  );
}
